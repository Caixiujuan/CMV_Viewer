    ...
    return {
        ...
        */
        ...
        operationalLayers: [{
			...
			title: '三环泡国家自然保护区边界线',
            options: {
                id: 'HLJwetland',//ID与图层相对应才能够实现打印功能， 需要验证。
                opacity: 1.0,
                visible: true,
                outFields: ['*'],
                mode: 0
        ...
        },*/
		 {
			...
			url: 'https://10.10.11.94:6443/arcgis/rest/services/XiaobeihuNNR/XiaobeihuNNR/MapServer',
        ...
        */
        ...
        widgets: {
            ...
            ssearch: {
                ...
                title: i18n.viewer.widgets.ssearch,
                iconClass: 'fa-search',
                position: 0,
                options: {
                    map: true,
            ...
            print: {
                ...
                options:{
                 ...
                 //printTaskURL: 'https://utility.arcgisonline.com/arcgis/rest/services/Utilities/PrintingTools/GPServer/Export%20Web%20Map%20Task',
                    printTaskURL: 'https://10.10.11.94:6080/arcgis/rest/services/Utilities/PrintingTools/GPServer/Export%20Web%20Map%20Task',
			...
			attributesTable: {
                ...
                tables: [
                    /*{
                        ...
                        queryOptions: {
                            queryParameters: {
                                url: 'https://10.10.11.94:6443/arcgis/rest/services/HLJbasicdata/MapServer/6',
			...
			wmsLayer: {
                ...
                title: i18n.viewer.widgets.wmsLayer,
            ...
            wmsLayer2: {
                ...
                title: i18n.viewer.widgets.wmsLayer2,
